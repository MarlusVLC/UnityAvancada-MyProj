...
namespace CommandPattern.RebindKeys
{
    ...
    public class GameController : MonoBehaviour
    {
        ...
        public float REPLAY_PAUSE_TIMER = 0.5f;
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Space))
            {
                ...
                SwapKeys(ref buttonS, ref buttonW);
            }
            ...
            {
                StartCoroutine(
                    Input.GetKey(KeyCode.RightShift) ? Rewind() : Replay());
        ...
        private static void SwapKeys(ref Command key1, ref Command key2)
        {
            (key1, key2) = (key2, key1);
        }
    }
